...
$$
W'=W+\Delta W,\qquad \Delta W=BA,\qquad \operatorname{rank}(\Delta W)\le r
$$

KL penalty：

$$
D_{\mathrm{KL}}(\pi_{\text{new}}\|\pi_{\text{ref}})
$$
...
$$
W_q=\operatorname{round}\left(\frac{W}{s}\right)s,\qquad
\operatorname{error}=W-W_q
$$
